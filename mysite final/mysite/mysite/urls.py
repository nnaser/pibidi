...
urlpatterns = patterns('',
		...
		url(r'^cotizar_kits_adm/',cotizar_view,name="cotizar_kits_adm"),
		...
		url(r'^ventas_kits_adm/',ventas_view,name="ventas_kits_adm"),
		url(r'^kits_adm/',kits_view,name="kits_adm"),
		url(r'^kits_vendedor/',kits_vendedor_view,name="kits_vendedor"),
		...
		url(r'^compatible_vendedor/',compatible_vendedor_view,name="compatible_vendedor"),
		url(r'^localizacion/',localizacion_view,name="localizacion"),
		url(r'^localizacion_vendedor/',localizacion_vendedor_view,name="localizacion_vendedor"),
